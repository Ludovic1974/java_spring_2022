package miprimeroproyecto.e.modificadoresacceso;

public class MiClaseCocheOtroPaquete {
...
//	public int altura; //mm
	...
	public MiClaseCocheOtroPaquete(String marque, String modele, int ruedas, int longueur, int largeur, int hauteur) {
		this.marca = marque;
		this.modele = modele;
		this.ruedas = ruedas;
	...
	// PERO QUÉ PASA SI HACEMOS USO DE PRIVATE
	// SE BLOQUEA TODO
	...
	public static String ejAcceso = "conectado"; // private, protected, public o (por defecto)
